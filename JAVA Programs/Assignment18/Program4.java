...
// Return the last position/index/last occurence of given element from array using user-defined method
...
/*
    ...
    */
    ...
    public static int lastPosition(ArrayList<Integer> aObj,Integer iNo)
    {
        int lPos=-1;
    ...
    public static void main(String args[])
    {
        try(Scanner sObj=new Scanner(System.in))
        {
            ...
            int iPos=lastPosition(aObj,iNo);
